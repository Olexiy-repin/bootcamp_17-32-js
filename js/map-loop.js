...
//   const strLengthesArr = arrOfStr.map(el => {
//     return el.length;
//   });
...
//   const resultArr = cars.map((el, idx, arr) => {
//     el.price = Number.parseFloat((el.price - el.price * discount).toFixed(1));
